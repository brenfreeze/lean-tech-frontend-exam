...
import { ADD_PROGRAM, UPDATE_PROGRAM } from "../services/queries"
      ...
      >
        {({
          ...
          >
            ...
            />
            <button type="submit" className="btn" disabled={isSubmitting} style={{ marginBottom: '0.5rem' }}>
              {isSubmitting ? "..." : "Save"}
            </button>
            <button className="btn outline" onClick={props.onClose} disabled={isSubmitting}>Cancel</button>
          </form>
        )}
      </Formik>
    </Modal>
